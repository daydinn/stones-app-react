    ...
    <section>
       ...
       <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl">
        ...
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          ...
          <img src="https://images.unsplash.com/photo-1521133573892-e44906baee46?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="key"
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg ">
              ...
              <p>
                <Link to="/SignIn" className="text-cyan-300 hover:text-cyan-500 transition duration-200 ease-in-out ml-1">Sign in instead ?</Link>
              </p>
            </div>
            <button className="w-full bg-cyan-300 text-white px-7 py-3  text-sm font-medium uppercase rounded shadow-md hover:bg-cyan-500 transition duration-150 ease-in-out hover:shadow-lg active:bg-cyan-800" type="submit">Send reset password</button>
